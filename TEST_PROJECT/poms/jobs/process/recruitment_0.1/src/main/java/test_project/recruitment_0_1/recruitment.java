...
package test_project.recruitment_0_1;
 ...
 * @status
 */
public class recruitment implements TalendJob {
	...
	private final String jobName = "recruitment";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(recruitment.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TEST_PROJECT_recruitment = new byte[0];
		static byte[] commonByteArray_TEST_PROJECT_recruitment = new byte[0];
		...
		public void copyDataTo(row1Struct other) {
			...
			other._id = this._id;
			other.attrition = this.attrition;
			other.performance_rating = this.performance_rating;
			other.sales_quota_pct = this.sales_quota_pct;
			other.recruiting_source = this.recruiting_source;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_PROJECT_recruitment.length) {
					if (length < 1024 && commonByteArray_TEST_PROJECT_recruitment.length == 0) {
						commonByteArray_TEST_PROJECT_recruitment = new byte[1024];
					} else {
						commonByteArray_TEST_PROJECT_recruitment = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_PROJECT_recruitment, 0, length);
				strReturn = new String(commonByteArray_TEST_PROJECT_recruitment, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_PROJECT_recruitment) {
					...
					while (cursor_tMongoDBInput_1.hasNext()) {
						...
						try {
							...
							updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("attrition"),
									"attrition", row1.attrition);
							updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("performance_rating"),
									"performance_rating", row1.performance_rating);
							updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("sales_quota_pct"),
									"sales_quota_pct", row1.sales_quota_pct);
							updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("recruiting_source"),
									"recruiting_source", row1.recruiting_source);
	...
	public static void main(String[] args) {
		final recruitment recruitmentClass = new recruitment();

		int exitCode = recruitmentClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = recruitment.class.getClassLoader()
					.getResourceAsStream("test_project/recruitment_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = recruitment.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : recruitment");
		}
...
/************************************************************************************************
 * 47536 characters generated by Talend Open Studio for Big Data on the March
 * 27, 2020 8:31:45 PM WET
 ************************************************************************************************/