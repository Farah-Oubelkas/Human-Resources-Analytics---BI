...
package test_project.dim_accident_0_1;
...
public class dim_accident implements TalendJob {
	...
	public static class dim_accidentStruct implements routines.system.IPersistableRow<dim_accidentStruct> {
		final static byte[] commonByteArrayLock_TEST_PROJECT_dim_accident = new byte[0];
		static byte[] commonByteArray_TEST_PROJECT_dim_accident = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_PROJECT_dim_accident.length) {
					if (length < 1024 && commonByteArray_TEST_PROJECT_dim_accident.length == 0) {
						commonByteArray_TEST_PROJECT_dim_accident = new byte[1024];
					} else {
						commonByteArray_TEST_PROJECT_dim_accident = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_PROJECT_dim_accident, 0, length);
				strReturn = new String(commonByteArray_TEST_PROJECT_dim_accident, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_PROJECT_dim_accident) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_accident.class.getClassLoader()
					.getResourceAsStream("test_project/dim_accident_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 84299 characters generated by Talend Open Studio for Big Data on the March
 * 27, 2020 8:41:22 PM WET
 ************************************************************************************************/