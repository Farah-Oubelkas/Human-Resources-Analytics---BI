...
package test_project.dim_temps_0_1;
...
public class dim_temps implements TalendJob {
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_TEST_PROJECT_dim_temps = new byte[0];
		static byte[] commonByteArray_TEST_PROJECT_dim_temps = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_PROJECT_dim_temps) {
	...
	public static class llStruct implements routines.system.IPersistableRow<llStruct> {
		final static byte[] commonByteArrayLock_TEST_PROJECT_dim_temps = new byte[0];
		static byte[] commonByteArray_TEST_PROJECT_dim_temps = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(llStruct other) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_PROJECT_dim_temps.length) {
					if (length < 1024 && commonByteArray_TEST_PROJECT_dim_temps.length == 0) {
						commonByteArray_TEST_PROJECT_dim_temps = new byte[1024];
					} else {
						commonByteArray_TEST_PROJECT_dim_temps = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_PROJECT_dim_temps, 0, length);
				strReturn = new String(commonByteArray_TEST_PROJECT_dim_temps, 0, length, utf8Charset);
			}
			return strReturn;
		}
	...
	public void tMongoDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "ll");
				}
...
// ###############################
				...
				try { // link with the "finally" on the "finally.javajet"
					...
					pathMap_tMongoDBInput_1.put("location", "");
					pathMap_tMongoDBInput_1.put("overtime_hours", "");
					...
					while (cursor_tMongoDBInput_1.hasNext()) {
						...
						valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
								.getValue(pathMap_tMongoDBInput_1.get("location"), "location", o_tMongoDBInput_1);
						if (valueObj_tMongoDBInput_1 != null && valueObj_tMongoDBInput_1.toString().length() > 0) {
							row1.location = valueObj_tMongoDBInput_1.toString();
						} else {
							row1.location = null;
						}
						valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1.getValue(
								pathMap_tMongoDBInput_1.get("overtime_hours"), "overtime_hours", o_tMongoDBInput_1);
						if (valueObj_tMongoDBInput_1 != null && valueObj_tMongoDBInput_1.toString().length() > 0) {
							if (valueObj_tMongoDBInput_1.getClass().equals(Double.class)) {
								row1.overtime_hours = ParserUtils.parseTo_Double(valueObj_tMongoDBInput_1.toString())
										.intValue();
							} else {
								row1.overtime_hours = ParserUtils.parseTo_Integer(valueObj_tMongoDBInput_1.toString());
							}
						} else {
							row1.overtime_hours = null;
						}
...
// Start of branch "ll"
						if (ll != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection(iterateId, 1, 1, "ll");
							}

							row3 = null;
							finder_tUniqRow_1.year = ll.year;
							finder_tUniqRow_1.hashCodeDirty = true;
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

								new_tUniqRow_1.year = ll.year;
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "ll");
				}
	...
	public void tMongoDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(ll)
				...
				try { // link with the "finally" on the "finally.javajet"
					...
					pathMap_tMongoDBInput_2.put("accident_type", "");
					...
					while (cursor_tMongoDBInput_2.hasNext()) {
						...
						valueObj_tMongoDBInput_2 = dbObjectInputUtil_tMongoDBInput_2.getValue(
								pathMap_tMongoDBInput_2.get("accident_type"), "accident_type", o_tMongoDBInput_2);
						if (valueObj_tMongoDBInput_2 != null && valueObj_tMongoDBInput_2.toString().length() > 0) {
							row2.accident_type = valueObj_tMongoDBInput_2.toString();
						} else {
							row2.accident_type = null;
						}
						...
						row2_HashRow.accident_type = row2.accident_type;
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_temps.class.getClassLoader()
					.getResourceAsStream("test_project/dim_temps_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 86895 characters generated by Talend Open Studio for Big Data on the March
 * 27, 2020 8:06:01 PM WET
 ************************************************************************************************/