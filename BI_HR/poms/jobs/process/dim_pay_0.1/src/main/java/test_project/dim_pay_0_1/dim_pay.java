...
package test_project.dim_pay_0_1;
 ...
 * @status
 */
public class dim_pay implements TalendJob {
	...
	private final String jobName = "dim_pay";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_pay.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TEST_PROJECT_dim_pay = new byte[0];
		static byte[] commonByteArray_TEST_PROJECT_dim_pay = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_PROJECT_dim_pay.length) {
					if (length < 1024 && commonByteArray_TEST_PROJECT_dim_pay.length == 0) {
						commonByteArray_TEST_PROJECT_dim_pay = new byte[1024];
					} else {
						commonByteArray_TEST_PROJECT_dim_pay = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_PROJECT_dim_pay, 0, length);
				strReturn = new String(commonByteArray_TEST_PROJECT_dim_pay, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_PROJECT_dim_pay) {
	...
	public void tMongoDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pathMap_tMongoDBOutput_1.put("new_hire", "");
				...
				try { // link with the "finally" on the "finally.javajet"
					...
					pathMap_tMongoDBInput_1.put("new_hire", "");
					...
					while (cursor_tMongoDBInput_1.hasNext()) {
						...
						valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
								.getValue(pathMap_tMongoDBInput_1.get("new_hire"), "new_hire", o_tMongoDBInput_1);
						if (valueObj_tMongoDBInput_1 != null && valueObj_tMongoDBInput_1.toString().length() > 0) {
							row1.new_hire = valueObj_tMongoDBInput_1.toString();
						} else {
							row1.new_hire = null;
						}
						valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
						...
						try {
							...
							updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("salary"), "salary",
									row1.salary);
							updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("new_hire"), "new_hire",
									row1.new_hire);
							updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("job_level"),
									"job_level", row1.job_level);
	...
	public static void main(String[] args) {
		final dim_pay dim_payClass = new dim_pay();

		int exitCode = dim_payClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_pay.class.getClassLoader()
					.getResourceAsStream("test_project/dim_pay_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_pay.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_pay");
		}
...
/************************************************************************************************
 * 47541 characters generated by Talend Open Studio for Big Data on the April
 * 20, 2020 6:24:14 PM WET
 ************************************************************************************************/