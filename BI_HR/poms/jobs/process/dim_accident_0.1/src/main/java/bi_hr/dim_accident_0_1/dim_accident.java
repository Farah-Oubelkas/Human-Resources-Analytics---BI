...
package bi_hr.dim_accident_0_1;
 ...
 * @status
 */
public class dim_accident implements TalendJob {
	...
	private final String jobName = "dim_accident";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_accident.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class dim_accidentStruct implements routines.system.IPersistableRow<dim_accidentStruct> {
		final static byte[] commonByteArrayLock_BI_HR_dim_accident = new byte[0];
		static byte[] commonByteArray_BI_HR_dim_accident = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BI_HR_dim_accident.length) {
					if (length < 1024 && commonByteArray_BI_HR_dim_accident.length == 0) {
						commonByteArray_BI_HR_dim_accident = new byte[1024];
					} else {
						commonByteArray_BI_HR_dim_accident = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BI_HR_dim_accident, 0, length);
				strReturn = new String(commonByteArray_BI_HR_dim_accident, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BI_HR_dim_accident) {
		 ...
		 * Compare keys
		 */
		public int compareTo(dim_accidentStruct other) {
	...
	public void tMongoDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				dim_accidentStruct dim_accident = new dim_accidentStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "dim_accident");
				}
				...
				pathMap_tMongoDBOutput_1.put("accident_id", "");

				pathMap_tMongoDBOutput_1.put("year", "");

				pathMap_tMongoDBOutput_1.put("employee_id", "");

				pathMap_tMongoDBOutput_1.put("accident_type", "");

				pathMap_tMongoDBOutput_1.put("location", "");

				pathMap_tMongoDBOutput_1.put("overtime_hours", "");
...
// # Outputs initialization
				dim_accidentStruct dim_accident_tmp = new dim_accidentStruct();
// ###############################
				...
				try { // link with the "finally" on the "finally.javajet"
					...
					pathMap_tMongoDBInput_1.put("year", "");
					pathMap_tMongoDBInput_1.put("employee_id", "");
					pathMap_tMongoDBInput_1.put("accident_type", "");
					...
					while (cursor_tMongoDBInput_1.hasNext()) {
						...
						valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
								.getValue(pathMap_tMongoDBInput_1.get("year"), "year", o_tMongoDBInput_1);
						if (valueObj_tMongoDBInput_1 != null && valueObj_tMongoDBInput_1.toString().length() > 0) {
							if (valueObj_tMongoDBInput_1.getClass().equals(Double.class)) {
								row1.year = ParserUtils.parseTo_Double(valueObj_tMongoDBInput_1.toString()).intValue();
							} else {
								row1.year = ParserUtils.parseTo_Integer(valueObj_tMongoDBInput_1.toString());
							}
						} else {
							row1.year = null;
						}
						...
						valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1.getValue(
								pathMap_tMongoDBInput_1.get("accident_type"), "accident_type", o_tMongoDBInput_1);
						if (valueObj_tMongoDBInput_1 != null && valueObj_tMongoDBInput_1.toString().length() > 0) {
							row1.accident_type = valueObj_tMongoDBInput_1.toString();
						} else {
							row1.accident_type = null;
						}
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.year = '" + row2HashKey.year
							// + "', row2.employee_id = '" + row2HashKey.employee_id + "'");
						} // G 071
...
// # Output table : 'dim_accident'
							dim_accident_tmp.accident_id = Numeric.sequence("s1", 1, 1);
							dim_accident_tmp.year = row1.year;
							dim_accident_tmp.employee_id = row1.employee_id;
							dim_accident_tmp.accident_type = row1.accident_type;
							dim_accident_tmp.location = row2.location;
							dim_accident_tmp.overtime_hours = row2.overtime_hours;
							dim_accident = dim_accident_tmp;
// ###############################
						 ...
						 */
// Start of branch "dim_accident"
						if (dim_accident != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection(iterateId, 1, 1, "dim_accident");
							}

							try {
								updateObjectUtil_tMongoDBOutput_1.setObject(new org.bson.Document());

								updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("accident_id"),
										"accident_id", dim_accident.accident_id);
								updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("year"), "year",
										dim_accident.year);
								updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("employee_id"),
										"employee_id", dim_accident.employee_id);
								updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("accident_type"),
										"accident_type", dim_accident.accident_type);
								updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("location"),
										"location", dim_accident.location);
								updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("overtime_hours"),
										"overtime_hours", dim_accident.overtime_hours);
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "dim_accident");
				}
	...
	public void tMongoDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(dim_accident)
				...
				try { // link with the "finally" on the "finally.javajet"
					...
					pathMap_tMongoDBInput_2.put("year", "");
					pathMap_tMongoDBInput_2.put("employee_id", "");
					pathMap_tMongoDBInput_2.put("location", "");
					pathMap_tMongoDBInput_2.put("overtime_hours", "");
					...
					while (cursor_tMongoDBInput_2.hasNext()) {
						...
						valueObj_tMongoDBInput_2 = dbObjectInputUtil_tMongoDBInput_2
								.getValue(pathMap_tMongoDBInput_2.get("year"), "year", o_tMongoDBInput_2);
						if (valueObj_tMongoDBInput_2 != null && valueObj_tMongoDBInput_2.toString().length() > 0) {
							if (valueObj_tMongoDBInput_2.getClass().equals(Double.class)) {
								row2.year = ParserUtils.parseTo_Double(valueObj_tMongoDBInput_2.toString()).intValue();
							} else {
								row2.year = ParserUtils.parseTo_Integer(valueObj_tMongoDBInput_2.toString());
							}
						} else {
							row2.year = null;
						}
						...
						valueObj_tMongoDBInput_2 = dbObjectInputUtil_tMongoDBInput_2
								.getValue(pathMap_tMongoDBInput_2.get("location"), "location", o_tMongoDBInput_2);
						if (valueObj_tMongoDBInput_2 != null && valueObj_tMongoDBInput_2.toString().length() > 0) {
							row2.location = valueObj_tMongoDBInput_2.toString();
						} else {
							row2.location = null;
						}
						valueObj_tMongoDBInput_2 = dbObjectInputUtil_tMongoDBInput_2.getValue(
								pathMap_tMongoDBInput_2.get("overtime_hours"), "overtime_hours", o_tMongoDBInput_2);
						if (valueObj_tMongoDBInput_2 != null && valueObj_tMongoDBInput_2.toString().length() > 0) {
							if (valueObj_tMongoDBInput_2.getClass().equals(Double.class)) {
								row2.overtime_hours = ParserUtils.parseTo_Double(valueObj_tMongoDBInput_2.toString())
										.intValue();
							} else {
								row2.overtime_hours = ParserUtils.parseTo_Integer(valueObj_tMongoDBInput_2.toString());
							}
						} else {
							row2.overtime_hours = null;
						}
						...
						row2_HashRow.location = row2.location;

						row2_HashRow.overtime_hours = row2.overtime_hours;
	...
	public static void main(String[] args) {
		final dim_accident dim_accidentClass = new dim_accident();

		int exitCode = dim_accidentClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_accident.class.getClassLoader()
					.getResourceAsStream("bi_hr/dim_accident_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_accident.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_accident");
		}
...
/************************************************************************************************
 * 84649 characters generated by Talend Open Studio for Big Data on the April
 * 20, 2020 10:13:04 PM WET
 ************************************************************************************************/